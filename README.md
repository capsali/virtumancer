...
* **VM Lifecycle Management**: Start, stop, shutdown, reboot, force-off, and force-reset virtual machines.  
* **Real-Time Monitoring**: Live-stream CPU, memory, disk I/O, and network statistics for running VMs directly to the UI.  
* **Enhanced API Integration**: Direct libvirt API calls for memory, CPU, storage, and security configurations with real-time data accuracy.  
...
* **Enhanced Disk Management**: Accurate disk size calculation with comprehensive storage pool and volume management.
...
* **Storage Management**: Complete storage pool, volume, and disk attachment management across all hosts.
* **Network Management**: Comprehensive network, port, and port attachment management.
* **Video/Graphics Management**: Support for video models and physical GPU management.
* **Console Access**: VNC and SPICE console proxying for direct VM access.
* **Dashboard & Analytics**: System-wide statistics, activity monitoring, and performance metrics.
* **Settings Management**: Configurable metrics settings and system preferences.
* **Host Capabilities**: Automatic discovery and caching of host capabilities and features.
...
3. **Run the application:**  
   ...
   The backend server will start, typically on https://localhost:8890. The first run will automatically create and migrate the virtumancer.db SQLite database file in the root directory.
...
│   │   └── discovered_vms.go   \# Discovered VM management functions.  
│   └── ws/  
...
### **API Documentation**
- **API.md**: Complete REST and WebSocket API reference with all endpoints
- **Database_Schema_Documentation.md**: Comprehensive database schema and relationships
...
- **ENHANCED_API_IMPLEMENTATION.md**: Direct libvirt API integration details
- **HOST_CAPABILITY_IMPLEMENTATION.md**: Host capability discovery implementation
- **TASK_STATUS_IMPLEMENTATION.md**: Asynchronous task management
...
Direct libvirt API calls for comprehensive VM configuration:
- **Memory APIs**: Real-time memory parameters and ballooning information
- **CPU APIs**: Live VCPU counts, pinning, and performance statistics
- **Storage APIs**: Block device information and job status
...
- **Storage Volumes**: Disk images, ISOs, and other volume management
- **Disk Attachments**: VM-to-disk mappings with detailed metadata
- **Real-time Statistics**: Block I/O performance monitoring

### **Network Management**
Comprehensive network infrastructure support:
- **Networks**: Virtual networks, bridges, and NAT configurations
- **Ports**: Virtual network interfaces with MAC addresses and models
- **Port Attachments**: VM-to-network interface mappings
- **Port Groups**: OpenVSwitch portgroup and VLAN support
...
### **Enhanced Libvirt API Integration**
- **Direct API Calls**: Replaced XML parsing with direct libvirt API calls for 5 major configuration areas
- **Real-time Data**: Live memory, CPU, storage, and security configurations
- **Performance Benefits**: Reduced XML parsing overhead and improved data accuracy
- **Graceful Degradation**: Fallback to XML parsing when APIs are unavailable

### **Comprehensive Storage Management**
- **Storage Pool Support**: Full CRUD operations for storage pools across hosts
- **Volume Management**: Complete volume lifecycle management
- **Disk Attachments**: Enhanced disk-to-VM attachment tracking
- **Performance Monitoring**: Real-time block I/O statistics

### **Advanced Network Infrastructure**
- **Network Management**: Complete network CRUD operations
- **Port Management**: Virtual NIC management with advanced features
- **Port Attachments**: VM network interface tracking
- **OpenVSwitch Support**: Portgroup and VLAN configuration

### **Video and Graphics Support**
- **Video Models**: Template-based video device management
- **Physical GPUs**: Host GPU discovery and passthrough support
- **VM Attachments**: Video device assignment to VMs

### **Console and Remote Access**
- **VNC Proxy**: WebSocket-based VNC console access
- **SPICE Support**: SPICE protocol console connections
- **Secure Access**: TLS-encrypted console connections

### **Dashboard and Analytics**
- **System Statistics**: Aggregated host and VM statistics
- **Activity Monitoring**: Recent system events and operations
- **Performance Metrics**: CPU, memory, and I/O utilization tracking
- **Real-time Updates**: Live dashboard data via WebSockets

### **Settings and Configuration**
- **Metrics Settings**: Configurable smoothing, units, and display options
- **Host Capabilities**: Automatic capability discovery and caching
- **User Preferences**: Persistent user interface settings
